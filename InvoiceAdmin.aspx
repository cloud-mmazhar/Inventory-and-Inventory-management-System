<%@ Page Title="" Language="C#" MasterPageFile="~/Invoice.master" AutoEventWireup="true" CodeFile="InvoiceAdmin.aspx.cs" Inherits="InvoiceAdmin" %>
												...
												<div class="right-bot-corner maxheight">
													<div class="left-bot-corner maxheight">
                                                        ...
                                                        <asp:TextBox ID="txtRcv_Date" runat="server"></asp:TextBox></div><br /><br />
                                                         <div class="field"><asp:label ID="Label14" runat="server" Font-Bold="True" ForeColor="#2CB6E9">PR No:</asp:label>
                                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                                                             &nbsp;
                                                        <asp:TextBox ID="txtPR_No" runat="server"></asp:TextBox></div><br /><br />
                                                         <div class="field"><asp:label ID="Label15" runat="server" Font-Bold="True" ForeColor="#2CB6E9">Payment Due Date:</asp:label>
                                                             &nbsp;&nbsp;&nbsp;&nbsp;
                                                        <asp:TextBox ID="txtPay_DueDate" runat="server"></asp:TextBox></div><br /><br />
                                                         <div class="field"><asp:label ID="Label16" runat="server" Font-Bold="True" ForeColor="#2CB6E9">PR Remark:</asp:label>
                                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;
                                                        <asp:TextBox ID="txtPR_Remark" runat="server"></asp:TextBox></div><br /><br />
                                                         <div class="field"><asp:label ID="Label17" runat="server" Font-Bold="True" ForeColor="#2CB6E9">FNA Receive On:</asp:label>
                                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp;
                                                        <asp:TextBox ID="txtFna_Rcv" runat="server"></asp:TextBox></div><br /><br />
                                                         <div class="field"><asp:label ID="Label18" runat="server" Font-Bold="True" ForeColor="#2CB6E9">FNA Remark:</asp:label>
                                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp &nbsp; &nbsp;
                                                        <asp:TextBox ID="txtFna_Rmk" runat="server"></asp:TextBox></div><br /><br />
                                                            <%--<h2>Medium  Solution points and pricings for each particular offer. Like this:</p>
															...
															<a href="#" class="button2"><em><b>Order now</b></em></a>--%>
														</div>
													</div>
												</div>
											</div>
												...
												<div class="right-bot-corner maxheight">
													<div class="left-bot-corner maxheight">
														<div class="inner">
                                                            ...
                                                            <br /><br /><br />
                                                            <div class="field"><asp:label ID="Label19" runat="server" Font-Bold="True" ForeColor="#2CB6E9">Payment Date:</asp:label>
                                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp&nbsp;&nbsp;&nbsp;
                                                        <asp:TextBox ID="txtPay_Date" runat="server"></asp:TextBox></div><br /><br />
                                                            <%--<p>Describe the solution in a couple of words.</p>
															<p>Why don’t you start with the selling points and pricings for each particular offer. Like this:</p>
