...
public partial class EmpUpdate : System.Web.UI.Page
{
    ...
    protected void DropDownList1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        txtLogID.Text = sName;
            ...
            InsCon.Open();
            cmd1 = new SqlCommand("Select * from EmployeeData where LoginID='" + DropDownList1.SelectedItem.Text + "'", InsCon);
    ...
    {        
        EmployeeBL elup = new EmployeeBL(txtLogID.Text, txtPswd.Text, Convert.ToInt64(txtPS_No.Text), txtE_Name.Text, txtE_ID.Text, Convert.ToDateTime(txtB_Date.Text), Convert.ToInt64(txtC_No.Text), Convert.ToDateTime(txtJ_Date.Text), Convert.ToInt64(txtSalary.Text), txtDept.Text, Convert.ToInt16(txtFloor.Text), Convert.ToInt16(txtX_Cord.Text), Convert.ToInt16(txtY_Cord.Text));
        elup.EmpUpdate();
