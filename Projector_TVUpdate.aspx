<%@ Page Title="" Language="C#" MasterPageFile="~/Inventory.master" AutoEventWireup="true" CodeFile="Projector_TVUpdate.aspx.cs" Inherits="Projector_TVUpdate" %>
												...
												<div class="right-bot-corner maxheight">
                                                    ...
                                                    <div class="field"><asp:label ID="lblSr_no" runat="server" Font-Bold="True" ForeColor="#2CB6E9">Serial No:</asp:label>
                                                        ...
                                                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                                                            ...
                                                            SelectCommand="SELECT * FROM [Projector_TV]"></asp:SqlDataSource>
                                                                </div>
                                                    </div><br /><br /><br />
                                                    <div class="field">
                                                    ...
                                                    <div class="field">
                                                    <div><asp:label ID="lblSerial_no" runat="server" Font-Bold="True" ForeColor="#2CB6E9">Resource Serial No:</asp:label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:TextBox ID="txtSerial_no" runat="server" ></asp:TextBox>
