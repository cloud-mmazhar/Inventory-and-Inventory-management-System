<%@ Page Title="" Language="C#" MasterPageFile="~/Inventory.master" AutoEventWireup="true" CodeFile="RouterUpdate.aspx.cs" Inherits="RouterUpdate" %>
												...
												<div class="right-bot-corner maxheight">
                                                    ...
                                                    <div class="field"><asp:label ID="lblSr_no" runat="server" Font-Bold="True" ForeColor="#2CB6E9">Serial No:</asp:label>
                                                        ...
                                                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                                                            ...
                                                            SelectCommand="SELECT * FROM [Router]"></asp:SqlDataSource>
                                                        <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                                                            ControlToValidate="txtE_Name" ErrorMessage="Please enter employee name.."></asp:RequiredFieldValidator>--%>
                                                                </div>
                                                    </div><br /><br /><br />
                                                    <div class="field">
                                                    <div><asp:label ID="lblType" runat="server" Font-Bold="True" ForeColor="#2CB6E9">Router Type:</asp:label>
                                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    ...
                                                    <div class="field">
                                                    <div><asp:label ID="lblSerial_no" runat="server" Font-Bold="True" ForeColor="#2CB6E9">Router Serial No:</asp:label>
