<%@ Page Title="" Language="C#" MasterPageFile="~/Inventory.master" AutoEventWireup="true" CodeFile="PrinterDelete.aspx.cs" Inherits="PrinterDelete" %>
												...
												<div class="right-bot-corner maxheight">
                                                    ...
                                                    <div class="field"><asp:label ID="lblSr_no" runat="server" Font-Bold="True" ForeColor="#2CB6E9">Serial No:</asp:label>
                                                        ...
                                                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                                                            ...
                                                            SelectCommand="SELECT * FROM [Printer]"></asp:SqlDataSource>
                                                                </div>
                                                    </div><br /><br /><br />
                                                    <div class="field">
                                                    <div><asp:label ID="lblMake_Model" runat="server" Font-Bold="True" ForeColor="#2CB6E9">Printer Make Model:</asp:label>
                                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    ...
                                                    <div class="field">
                                                    <div><asp:label ID="lblSerial_no" runat="server" Font-Bold="True" ForeColor="#2CB6E9">Printer Serial No:</asp:label>
                                                    ...
                                                    <div class="field">
                                                    <div><asp:label ID="lblAsset_no" runat="server" Font-Bold="True" ForeColor="#2CB6E9">Asset No:</asp:label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:TextBox ID="txtAsset_no" runat="server"></asp:TextBox>
                                                        ...
                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator6" runat="server" 
                                                            ...
                                                            <br />
                                                            <br />                                                     
                                                    <div class="field"><asp:label ID="lblPart_no" runat="server" Font-Bold="True" ForeColor="#2CB6E9">Part No:</asp:label>
                                                    ...
                                                    <div class="field"><asp:label ID="lblWarranty" runat="server" Font-Bold="True" ForeColor="#2CB6E9">Warranty:</asp:label>
                                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp&nbsp;&nbsp;<asp:TextBox ID="txtWarranty" runat="server"></asp:TextBox>
                                                    ...
                                                    <div class="field"><asp:label ID="lblX_Cord" runat="server" Font-Bold="True" ForeColor="#2CB6E9">X-Cord:</asp:label>
                                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:TextBox ID="txtX_Cord" runat="server"></asp:TextBox>
                                                    ...
                                                    <div class="field"><asp:label ID="lblY_Cord" runat="server" Font-Bold="True" ForeColor="#2CB6E9">Y-Cord:</asp:label>
                                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:TextBox ID="txtY_Cord" runat="server"></asp:TextBox>
