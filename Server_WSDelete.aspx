<%@ Page Title="" Language="C#" MasterPageFile="~/Inventory.master" AutoEventWireup="true" CodeFile="Server_WSDelete.aspx.cs" Inherits="Server_WSDelete" %>
										...
										<div class="left-top-corner maxheight">
											<div class="right-top-corner maxheight">
												<div class="right-bot-corner maxheight">
                                                    ...
                                                    <div class="field">
                                                    <div><asp:label ID="lblHardDisk" runat="server" Font-Bold="True" ForeColor="#2CB6E9">HardDisk Size:</asp:label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:TextBox ID="txtHardDisk" runat="server"></asp:TextBox>
